...
public class CarzzHelperClass {
    ...
    public CarzzHelperClass() {
    }

    public CarzzHelperClass(String marca, String model, String pretDeLa, String pretPanaLa, String anFabrDeLa, String anFabrPanaLa, String oras) {
        this.marca = marca;
        this.model = model;
