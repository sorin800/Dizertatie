...
import com.tsv.diz.service.interfaces.ScrapperOlx2;
...
@Service
public class ScrapperOlxImpl2 implements ScrapperOlx2 {
...
/*                for (int j = 0; j < pageSearch.size(); j++) {
                    ...
                    list.add(new SearchResultOlx(title, url, price, imgSrc, city));
                }*/
