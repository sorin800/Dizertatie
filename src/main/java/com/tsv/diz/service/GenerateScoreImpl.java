...
import com.tsv.diz.service.interfaces.GenerateScore;
...
@Service
public class GenerateScoreImpl implements GenerateScore {
	...
	private List<String> costuriMiciDeIntretinere = Arrays.asList("toyota", "honda", "mitsubishi", "mazda", "nissan",
			 "hyundai", "dacia", "opel", "skoda", "suzuki", "daewoo", "kia", "seat","renault");

	private List<String> costuriMediiDeIntretinere = Arrays.asList("ford", "land rover", "chevrolet", "jeep",
			"peugeot", "citroen", "daihatsu","volkswagen");
	...
	private List<String> dimensiuniMici = Arrays.asList("147", "gt", "a1", "a2", "a3", "tt", "seria 1", "kalos",
			"spark", "c1", "c2", "c3", "c4", "sandero", "matiz", "sirion", "bravo", "grande punto", "punto", "panda",
			"stilo", "fiesta", "focus", "ka", "streetka", "civic", "insight", "coupe", "getz", "i10", "i20", "i30",
			"ix20", "cee'd", "rio", "venga", "2", "rx-8", "colt", "space star", "micra", "agila", "astra", "corsa",
			"tigra", "107", "206", "207", "boxster", "twingo", "ibiza", "leon", "fabia", "alto", "spalsh", "auris",
			"aygo", "yaris", "beetle", "eos", "fox", "golf", "lupo", "scirocco", "v40");

	private List<String> dimensiuniMedii = Arrays.asList("156", "159", "166", "a4", "a5", "a6", "a8", "seria 3",
			"seria 5", "seria 6", "seria 7", "aveo", "cruze", "lacetti", "c4 picasso", "c5", "c6", "1300", "1310",
			"logan", "duster", "nubira", "cielo", "avenger", "caliber", "challenger", "charger", "albea", "croma",
			"linea", "qubo", "sedici", "tipo", "mondeo", "accord", "accent", "elantra", "sonata", "s-type", "x-type",
			"xf", "xj", "carens", "cerato", "optima", "3", "5", "6", "626", "premacy", "lancer", "almera", "tiida",
			"insignia", "omega", "rekord", "signum", "vectra", "zafira", "3008", "306", "307", "308", "406", "407",
			"5008", "508", "607", "espace", "fluence", "grand scenic", "kangoo", "laguna", "latitude", "megane",
			"scenic", "symbol", "alhambra", "altea", "cordoba", "exeo", "toledo", "felicia", "octavia", "rapid",
			"roomster", "superb", "yeti", "sx4", "avensis", "corolla", "prius", "tacoma", "bora", "caddy", "jetta",
			"passat", "passat cc", "phaeton", "c30", "c70", "s40", "s80", "s60", "s90", "v50", "v60");
