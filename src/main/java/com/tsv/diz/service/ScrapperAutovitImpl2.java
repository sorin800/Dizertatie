...
import com.tsv.diz.service.interfaces.ScrapperAutovit2;
...
@Service
public class ScrapperAutovitImpl2 implements ScrapperAutovit2{
	...
	private int iterationPartAutovit;
	private String img = "";
	...
	public List searchAutovit(String marca, String model, String pretDeLa, String pretPanaLa, String anFabrDeLa,
		...
		try {
			...
			//System.out.println(pageFinalNumber);
